...
const STORAGE_KEY = 'studcom:todos:global';

export const HomepageTodo: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">My To-Do List</h3>
