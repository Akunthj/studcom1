  ...
  return (
    <div className="w-80 bg-white border-r border-gray-200 flex flex-col h-full">
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-lg font-bold text-gray-900 mb-3">Subjects & Topics</h2>
        ...
        {filteredSubjects.map((subject) => (
          <div key={subject.id} className="mb-1">
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 transition text-left group"
            >
              {subject.expanded ? (
